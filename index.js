...
var games2 = [730, 440, 	1289310];  // Enter here AppIDs of the needed games
var status2 = 7;  // 1 - online, 7 - invisible


user2 = new steamUser();
user2.logOn({"accountName": username, "password": password, "twoFactorCode": steamTotp.generateAuthCode(shared_secret2)});
user2.on('loggedOn', () => {
